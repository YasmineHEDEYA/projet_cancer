...
include('../connexion_bd.php'); 
 ...
 if(isset($_POST['recherche_code'])) {
   ...
   // ON VERIFIE SI LE CODE EXISTE DANS LA TABLE 
	  $req =$bdd->prepare('SELECT COUNT(*) AS nbr FROM XX WHERE ORGANE LIKE :p_code');
    ...
    $req->closeCursor() ;
    	$req = $bdd->prepare('SELECT * FROM xx WHERE ORGANE LIKE :p_code');
        $req->execute(array(':p_code' => $_POST['code']));
    ...
    if ($_POST['critere'] == 'code_lesion') {
     ...
     // ON VERIFIE SI LE CODE EXISTE DANS LA TABLE 
	  $req =$bdd->prepare('SELECT COUNT(*) AS nbr FROM XX WHERE LESION LIKE :p_code');
	  $req->execute(array(':p_code' => $_POST['code']));
	  $ligne = $req->fetch() ;
    ...
    $req->closeCursor() ;
    	$req = $bdd->prepare('SELECT * FROM XX WHERE LESION LIKE :p_code');
        $req->execute(array(':p_code' => $_POST['code']));
    ...
    // ON VERIFIE SI LE CODE EXISTE DANS LA TABLE 
	  $req =$bdd->prepare('SELECT COUNT(*) AS nbr FROM XX WHERE CODTOPOCIMO3 LIKE :p_code');
	  $req->execute(array(':p_code' => $_POST['code']));
	  $ligne = $req->fetch() ;
    ...
    $req->closeCursor() ;
    	$req = $bdd->prepare('SELECT * FROM XX WHERE CODTOPOCIMO3 LIKE :p_code');
        $req->execute(array(':p_code' => $_POST['code']));
    ...
    if ($_POST['critere'] == 'cimo3_morpho') {
      ...
      // ON VERIFIE SI LE CODE EXISTE DANS LA TABLE 
	  $req =$bdd->prepare('SELECT COUNT(*) AS nbr FROM XX WHERE CODMORPHOCIMO3 LIKE :p_code');
	  $req->execute(array(':p_code' => $_POST['code']));
	  $ligne = $req->fetch() ;
    ...
    $req->closeCursor() ;
    	$req = $bdd->prepare('SELECT * FROM XX WHERE CODMORPHOCIMO3 LIKE :p_code');
        $req->execute(array(':p_code' => $_POST['code']));
