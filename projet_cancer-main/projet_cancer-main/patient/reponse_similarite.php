...
<?php
    session_start();
    $bdd = new PDO('mysql:host=localhost;dbname=ime202', 'root','');
    $rep= $_POST['repo'];
    if($rep== 'OUI') 
    {
      ...
      echo "<br/>";
       echo "<br/>";
      echo "<b> Aucun patient ajouté !</b>";
      echo "</br>";
       echo "</br>";
    } 
  else 
    {
      $value_nom = $_SESSION['nom_rep'];
       $value_prenom = $_SESSION['prenom_rep'];
       $value_date = $_SESSION['date_rep'];
