...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="accueil.php">
   <img src="../style/logo.svg" width="30" height="30">
    </a>

  <div class="collapse navbar-collapse">
   <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" href="#">Registre des cancers</a>
      </li>
      <li class="nav-item">
...
//test
  ...
  <tbody>';
    ...
    <?php echo "<h3>nombre de lignes: ".$nb."</h3>"; ?>
                        ...
                        <input class="btn btn-info " onclick="window.location.href='accueil_cancer.php'"type="submit" name="btnSup" value="RETOUR" />
                    
                    <button class="btn btn-info" onclick="exportTableToCSV('tous_les_cancers.csv')">Exporter en CSV</button>
                <br />
                <br/>
            </div>
