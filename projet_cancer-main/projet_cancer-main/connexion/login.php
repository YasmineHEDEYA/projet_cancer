...
<div class="container beige">
        <form class="text-center p-4" action="test_cnx.php" method="POST" >
            ...
            <img src="../style/_logo .svg" width=280px height=200px/>
            <legend>
            ...
            <input type="password" class="form-control" placeholder="Mot de passe*" name='mdp' required>
             <label style="font-size: 14px; padding-left: 240px; ">
                 <a href="change_mdp.php" class="float-right">Changer le mot de passe</a>
             </label>
            <br />
            ...
            <button class="btn btn-info" type="submit" >Se connecter</button>
             <div class="mt-4 text-center">
                  Vous n'avez pas de compte ? <a href="inscription.php">Créer un</a>
                </div>
        </form>
        <br />
    </div>
